...
export function MavipSection() {
  return (
    ...
    >
      <div className="mx-auto flex min-h-[calc(100svh-var(--header-h))] w-full max-w-[1600px] flex-col px-5 pt-7 pb-6 sm:px-8 lg:px-12">
        ...
        <div className="mt-6 grid flex-1 grid-cols-1 gap-x-10 gap-y-7 lg:grid-cols-12">
          {/* ── The story ──────────────────────────── */}
          <div className="flex flex-col lg:col-span-5">
            ...
            <dl className="mt-5 grid grid-cols-2 gap-x-6 gap-y-3.5 border-t border-hair pt-4 sm:grid-cols-3 lg:grid-cols-2">
              {mavipMetrics.map((m) => (
                <div key={m.label}>
          ...
          <div className="flex flex-col lg:col-span-7">
            ...
            {/* One artifact, opened on the slide that carries the problem
                statement and the research behind it. */}
        ...
        <div className="mt-5 shrink-0 border-t border-hair pt-4">
